...
import RtuxOffCanvasFilterPlugin from './rtux-offcanvas-filter/rtux-offcanvas-filter.plugin';

const PluginManager = window.PluginManager;

PluginManager.register('RtuxListingFilterPlugin', RtuxListingFilterPlugin, '[data-rtux-listing-filter]');
PluginManager.register('RtuxOffCanvasFilter', RtuxOffCanvasFilterPlugin, '[data-rtux-offcanvas-filter]');
